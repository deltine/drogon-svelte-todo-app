...
class Account
{
  public:
    ...
    void getTodoTask(const drogon::orm::DbClientPtr &clientPtr,
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where account_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where account_id = ?";
        return sql;
    }
